...
public class ControlDeviceBank : MonoBehaviour {
    ...
    public static ControlDeviceBank instance = null;
    ...
    public delegate void OnNewPlayer(AControlDevice new_device);
    public OnNewPlayer on_new_player;
    ...
    void SearchForNewPlayers(){
        ...
        Assert.IsNotNull(on_new_player);
